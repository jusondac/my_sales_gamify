...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference("Inventory.count") do
      post inventories_url, params: { inventory: { product_id: @inventory.product_id, stock: @inventory.stock } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { product_id: @inventory.product_id, stock: @inventory.stock } }
